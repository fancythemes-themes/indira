 ...
 */
function indira_sanitize_layout($value) {
 ...
 */
function indira_sanitize_color_field($value) {
	return $value;
}
 ...
 * @return HTML string sanitized with wpkses.
 */
function indira_sanitize_blog_list_view($value) {
 ...
 * @return HTML string sanitized with wpkses.
 */
function indira_sanitize_footer_credit($value) {
	$allowed_tags = array(
						'a' => array(
							'href' => array(),
							'title' => array(),
 ...
 */
function indira_sanitize_checkbox( $checked ) {
	// Boolean check.
 ...
 */
function indira_sanitize_number_absint( $number, $setting ) {
 ...
 */
function indira_sanitize_image( $image, $setting ) {
	/*
